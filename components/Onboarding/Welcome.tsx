...
export const Welcome = () => {
  return (
    <div className="flex flex-col px-32 py-20 justify-center h-screen max-w-4xl">
      ...
      <Paragraphe className="p-2.5 bg-primary font-medium text-[#087F83] text-2xl leading-8 rounded-lg mt-10 w-fit">
        🕓 En moins de 5 minutes, vous êtes opérationnel
      </Paragraphe>
      <Button
        primary={false}
        classname="!bg-primary !border-primary hover:!bg-transparent hover:!text-secondary w-fit text-2xl font-semibold mt-10 transition-colors"
      >
        C&apos; est parti !
      </Button>
      <Notices classname="text-2xl mt-12">
