...
export const AssistanceIA = () => {
  return (
    <div className="flex flex-col py-10 px-48 items-center">
      <svg
        width="80"
        height="80"
        viewBox="0 0 100 100"
      ...
      <Title
        level={1}
        className="font-semibold mt-4 text-black text-xl text-center"
      >
        Assistant Legaleo
      </Title>
      <Title
        level={2}
        className="font-semibold text-black text-2xl text-center mt-11"
      >
        Quel est le programme aujourd’hui ?
      </Title>
      <div className="flex flex-col gap-2.5 mt-10 justify-center items-center">
        <span className="font-semibold text-base text-center text-[#087F83] px-3.5 py-1.5 bg-[#F2F8F8] w-fit rounded-full cursor-pointer hover:opacity-85 transition-all duration-300">
      ...
      <Paragraphe className="text-center text-sm text-[#828282] font-medium mt-11 max-w-4xl">
        Legaleo fournit des informations à caractère général. Il ne s’agit pas
        d’un conseil juridique personnalisé. Pour toute situation particulière,
        nous vous invitons à contacter un avocat partenaire Legaleo.
      </Paragraphe>
      <form className="w-4xl border-[#E3E3E3] border rounded-full flex flex-row gap-2 justify-between items-center mt-20 shadow-md py-3.5 px-6">
        <input
          type="text"
          placeholder="Poser une question"
          className="w-[90%] px-6 py-3 rounded-full outline-none placeholder:text-[#828282] text-sm font-medium"
        />
