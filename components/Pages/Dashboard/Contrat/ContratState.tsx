  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case "relecture interne":
        return (
          <p className="px-2.5 py-2.5 bg-[#FACC15] uppercase text-base text-white font-bold rounded-md">
            {status}
          </p>
        );
      case "relecture avocat":
        return (
          <p className="px-2.5 py-2.5 bg-[#C500DB] uppercase text-base text-white font-bold rounded-md">
            {status}
          </p>
        );
      case "en cours de signature":
        return (
          <p className="px-2.5 py-2.5 bg-[#00A5EB] uppercase text-base text-white font-bold rounded-md">
            {status}
          </p>
        );
      case "Modifications requises":
        return (
          <p className="px-2.5 py-2.5 bg-[#A3310F] uppercase text-base text-white font-bold rounded-md">
            {status}
          </p>
        );
    }
