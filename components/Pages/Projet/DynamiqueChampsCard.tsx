...
export const DynamiqueChampsCard = () => {
  ...
  return (
    <div
      className="bg-white shadow border border-gray rounded-sm flex flex-col gap-2.5 absolute right-1/2 translate-x-[50%] bottom-[-800%] w-[300px]"
    ...
    >
      ...
      <div className="flex flex-col gap-0 pb-5">
        <div className="flex flex-row gap-2.5 bg-white font-medium text-sm py-2.5 px-5 hover:bg-[#F2F8F8] cursor-pointer">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
