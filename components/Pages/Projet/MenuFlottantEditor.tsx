export const MenuFlottantEditor = () => {
  return (
    <div className="flex flex-row bg-white rounded-sm shadow border border-[#E3E3E3] absolute top-4 right-4 z-20 px-3.5 py-2.5 gap-2.5">
      <div className="relative cursor-pointer group">
        ...
        <span className="px-1.5 py-1 bg-[#087F83] text-white w-fit text-nowrap font-medium text-sm group-hover:block hidden absolute top-[-150%] left-1/2 translate-x-[-50%] rounded-sm">
          Copier
        </span>
      </div>
      <div className="relative cursor-pointer group">
        ...
        <span className="px-1.5 py-1 bg-[#087F83] text-white w-fit font-medium text-sm group-hover:block hidden absolute top-[-150%] left-1/2 translate-x-[-50%] rounded-sm">
          Coller
        </span>
      </div>
      <div className="relative cursor-pointer group">
